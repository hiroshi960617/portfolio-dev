        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-1xl font-bold mb-2">Blockchain & Fullstack Developer</h3>
              ...
              <p className="text-white/80 mb-6 leading-relaxed">
                I'm a passionate developer specializing in blockchain technologies and fullstack development. With
                expertise in smart contracts, dApps, and modern web frameworks, I build secure, scalable solutions for
                the decentralized web. My focus is on creating innovative applications that bridge traditional web
                development with cutting-edge blockchain technology.
              </p>
              <div className="grid grid-cols-2 gap-4 mb-6">
                <motion.div
                  className="flex items-center gap-2 p-3 rounded-lg bg-white/10 border border-white/20 hover:bg-white/15 hover:border-cyan-400/30 transition-all duration-300"
                  whileHover={{ scale: 1.02 }}
                >
                  <Code className="text-cyan-400 flex-shrink-0" size={18} />
                  <span className="text-sm font-medium">Smart Contracts</span>
                </motion.div>
                <motion.div
                  className="flex items-center gap-2 p-3 rounded-lg bg-white/10 border border-white/20 hover:bg-white/15 hover:border-purple-500/30 transition-all duration-300"
                  whileHover={{ scale: 1.02 }}
                >
                  <Globe className="text-purple-500 flex-shrink-0" size={18} />
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.02 }}
                >
                  <Server className="text-cyan-400 flex-shrink-0" size={18} />
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.02 }}
                >
                  <Database className="text-purple-500 flex-shrink-0" size={18} />
                  <span className="text-sm font-medium">Blockchain Architecture</span>
                </motion.div>
              </div>
              <Link href="/resume">
