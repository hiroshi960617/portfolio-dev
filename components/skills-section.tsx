...
export function SkillsSection() {
  const skills = [
    { name: "Solidity", level: 90, color: "from-cyan-500 to-cyan-300" },
    { name: "Ethereum", level: 85, color: "from-blue-500 to-blue-300" },
    { name: "Smart Contracts", level: 90, color: "from-indigo-500 to-indigo-300" },
    { name: "React", level: 95, color: "from-purple-500 to-purple-300" },
    { name: "Next.js", level: 90, color: "from-pink-500 to-pink-300" },
    { name: "TypeScript", level: 85, color: "from-cyan-500 to-cyan-300" },
    { name: "Node.js", level: 80, color: "from-green-500 to-green-300" },
    { name: "Web3.js / Ethers.js", level: 85, color: "from-yellow-500 to-yellow-300" },
  ]
